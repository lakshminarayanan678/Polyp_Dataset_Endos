...
# ====== CONFIG ======
input_dir = Path("/home/endoai/Desktop/PAPER/Real-COLON/004-008_annotations")  # Directory with XML annotation files
output_csv = Path("/home/endoai/Desktop/PAPER/Real-COLON/REAL_Colon/004-008/normalized.csv")
log_file = Path("/home/endoai/Desktop/PAPER/Real-COLON/REAL_Colon/004-008/log.txt")  # Log output
...
for xml_file in input_dir.rglob("*.xml"):
    ...
    image_filename = f"realcolon_{image_filename}"
